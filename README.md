# THIS CODE MAY NOT WORK AS EXPECTED, SO PLEASE TRY TO ADJUST.
...
def animate_text():
    for color in colors:
        ...
        pen.color(color)
        pen.goto(0, 0)
        pen.write("শুভ বার্ষিকী বাবা ও মা !!!", align='center', font=('Arial', 22, 'bold')) # This is the main text which will be shown in center.
        pen.penup()
        pen.goto(0, -30)
        pen.write("আপনার দিনটি সুখের হোক এই কামনা করি |", align='center', font=('Arial', 17, 'bold')) # This is the sub-main text.
        window.update()
        sleep(1)
...
def play_music():
    try:
        text = "শুভ বিবাহবার্ষিকী বাবা ও মা। আপনার দিনটি সুখের হোক এই কামনা করি।" # This text will be the speech
        tts = gTTS(text=text, lang='bn') # change 'bn' with your own language, like english - 'en'.
